    ...
    if opcion == "1":  # Agregar un helado
        ...
        if len(heladoos) == 0:  # Error corregido: variable incorrecta
            ...
            for helado in heladoos:
                print(f"ID: {helado['id']}, Nombre: {helado['nombre']}, Descripción: {helado['descripcion']}, Precio: ${helado['precio']:.2f}")  # Error corregido en claves del diccionario
        ...
        if id_modificar.isdigit():
            ...
            for helado in heladoos:
                if helado["id"] == id_modificar:
                    nuevo_nombre = input("Nuevo nombre (deje en blanco para no cambiar): ")  # Error corregido: doble signo igual
        ...
        if id_eliminar.isdigit():
            ...
            for helado in heladoos:
                if helado["id"] == id_eliminar:
                    heladoos.remove(helado)  # Error corregido: variable incorrecta
